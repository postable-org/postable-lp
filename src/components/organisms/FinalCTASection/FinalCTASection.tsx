...
export const FinalCTASection = () => {
  ...
  return (
    ...
    >
      ...
      <div ref={containerRef} className="reveal relative max-w-3xl mx-auto">
        {/* Card */}
        <div
          className="relative rounded-3xl p-px overflow-hidden"
          style={{
            background:
              "linear-gradient(135deg, rgba(56,189,248,0.4) 0%, rgba(14,165,233,0.1) 50%, rgba(56,189,248,0.3) 100%)",
          }}
        >
          {/* Shimmer */}
          <div
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: "#080912",
                boxShadow:
                  "0 4px 30px rgba(56,189,248,0.45), 0 0 60px rgba(56,189,248,0.15)",
              }}
            >
