    ...
    <section id="como-funciona" className="py-20 md:py-32 bg-white">
      <div ref={sectionRef} className="reveal max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center text-center gap-4 mb-12 md:mb-14">
          ...
          <h2 className="font-[family-name:var(--font-fraunces)] font-normal text-4xl md:text-5xl lg:text-6xl leading-[1.1] tracking-tight max-w-2xl text-[#0A0A0A]">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                transition:
                  "left 0.25s cubic-bezier(0.4,0,0.2,1), width 0.25s cubic-bezier(0.4,0,0.2,1), opacity 0.15s",
              }}
            />
            {STEPS.map((s, i) => (
              <div
          ...
          {STEPS.map((_, i) => (
            <div
              ...
              style={{
                ...
                boxShadow:
                  activeStep === i ? "0 0 8px rgba(56,189,248,0.5)" : "none",
              }}
            />
          ))}
        </div>
